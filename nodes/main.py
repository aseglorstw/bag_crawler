...
def main():
    ...
    # joy_control_coordinates = calculator.get_joy_control_coordinates(joy_control_times)
    # joy_control_binary = calculator.get_joy_control_binary(joy_control_times)
