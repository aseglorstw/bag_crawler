...
class GraphsCreator:
    ...
    def create_graph_xy_and_point_cloud(self, point_cloud):
        ...
        plt.legend()
        plt.savefig(f"{self.folder}/XY_plot_of_UGVs_movement.png")
        plt.close()
    ...
    def create_graph_x_over_time(self):
        ...
        plt.savefig(f"{self.folder}/UGVs_movement_in_X_direction.png")
        plt.close()
    ...
    def create_graph_y_over_time(self):
        ...
        plt.savefig(f"{self.folder}/UGVs_movement_in_Y_direction.png")
        plt.close()
    ...
    def create_graph_distance_over_time(self, distances_icp, distances_odom, start_of_moving, end_of_moving):
        ...
        plt.legend()
        plt.savefig(f"{self.folder}/UGVs_travelled_distance_over_time.png")
        plt.close()
